...
The script [below](../building/genCloudComPy_Conda310_Ubuntu2004.sh) executes the following:

 - create or update the conda environment
 - activate the environment
 - build and install CloudComPy (Sources must be cloned from the [GitLab repository](https://gitlab.com/openfields1/CloudComPy) and up to date)
 - create the tarfile
 - execute ctest
